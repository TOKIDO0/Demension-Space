...
public class PermissionController {
    ...
    @GetMapping
    public Result<List<List<Permission>>> findAll() {
        ...
        result.add(permissions0);
        result.add(permissions1);
        result.add(permissions2);
        result.add(permissions3);
        result.add(permissions4);
        result.add(permissions5);
    ...
    public Result<List<Permission>>
    getByRoles(@RequestBody List<Role> roles) {
